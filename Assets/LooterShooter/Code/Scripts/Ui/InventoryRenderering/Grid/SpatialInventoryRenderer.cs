...
{
    /// <summary>
    /// Base class for all spatial inventory renderers.
    /// </summary>
    public abstract class SpatialInventoryRenderer : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("_itemGrid")] [SerializeField] protected InventorySlotGrid _inventorySlotGrid;
        ...
        protected virtual void CreateNewDraggableItem(InventoryItem inventoryItem)
        {
            ...
            Logger.Write(LogLevel.DEBUG, gameObject.name, $"CreateNewDraggable '{inventoryItem.Metadata.ItemData.ItemName}'@{inventoryItem.Bounds.Position}");
        }
